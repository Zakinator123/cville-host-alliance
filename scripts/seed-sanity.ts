...
const blocks = (...text: string[]) =>
  text.map((t) => ({
    ...
    _type: 'block',
    style: 'normal',
    children: [{ _key: randomKey(), _type: 'span', text: t }],
  }))
...
const docs: SeedDoc[] = [
  {
    ...
    heroContent: {
      headline: 'Pause the rush. Include all stakeholders. Get the facts right.',
      subheadline:
        'The City is pushing STR regulations without input from the people most affected. Join local residents demanding a transparent, inclusive process before any decisions are made.',
      ctaLabel: 'Join Us',
  ...
  },
  {
    ...
    content: blocks(
      'We are asking the City to PAUSE further action on STR regulations until there is a transparent, inclusive process that addresses the following questions:',
  ...
  },
  {
    ...
    content: blocks(
      ...
      'We are asking the City to pause, step back, and have the conversation that should have happened from the beginning. Let\'s talk about what problems we\'re actually trying to solve, why residential operators should face stricter rules than commercial ones, and how we can create an equitable system that encourages—rather than prevents—local residents from participating in the tourism economy.',
  ...
  {
    _id: 'evidence.cville-str-data',
    _type: 'evidenceItem',
    title: 'Granicus identified 529 STRs in Charlottesville, 83% on single-family properties',
    slug: { _type: 'slug', current: 'cville-str-data' },
    category: 'operators',
    summary:
      'The City hired Granicus software to track STRs. They identified 529 listings, with 83% on single-family properties. 85% are entire-home rentals, 15% are partial-home (room rentals).',
    source: 'City of Charlottesville Homestay Ordinance Amendments presentation',
    sourceUrl: '#',
    stats: [
      { _key: 'stat1', label: 'Total STRs identified', value: '529' },
      { _key: 'stat2', label: 'On single-family properties', value: '83%' },
      { _key: 'stat3', label: 'Entire-home rentals', value: '85%' },
      { _key: 'stat4', label: 'Partial-home rentals', value: '15%' },
    ],
  },
  {
    ...
    description: blocks(
      ...
      'Tell Council: Pause the process. Include all stakeholders. Get the facts right before making decisions.',
    ),
    emailTemplate: blocks(
      'Dear City Council,',
      'My name is [YOUR NAME] and I live in [NEIGHBORHOOD]. I\'m writing to ask you to PAUSE further action on STR regulations until there is a transparent, inclusive process that involves all stakeholders.',
  ...
  },
  {
    ...
    answer: blocks(
      ...
      'We\'re asking for a pause, broader engagement, and a transparent process that includes all stakeholders—not just those who file complaints.',
    ),
    category: 'Process',
    order: 1,
  },
