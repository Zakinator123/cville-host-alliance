...
export const actionAlerts: ActionAlert[] = [
  {
    ...
    emailTemplate: [
      ...
      '• **Who has been meaningfully consulted?** We need to ensure NDS has adequately heard perspectives from all stakeholders, not just from folks who send complaints.',
